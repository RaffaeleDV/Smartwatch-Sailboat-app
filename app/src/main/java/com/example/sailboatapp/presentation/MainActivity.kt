...
import com.example.mapsok.presentation.theme.SailboatappTheme
...
/*
        val salerno = LatLng(40.6, 14.75)
        var anchor = false
        val listState = rememberScalingLazyListState()

        val cameraPositionState = rememberCameraPositionState {
            position = CameraPosition.fromLatLngZoom(salerno, 10f)
        }
        Box(
        ...
        )
        {
            GoogleMap(
                ...
                Marker(
                    state = MarkerState(position = salerno),
                    rotation = 0f,
