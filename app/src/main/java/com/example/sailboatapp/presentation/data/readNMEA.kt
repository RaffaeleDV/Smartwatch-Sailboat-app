                        ...
                        if (row[0].isNotEmpty()) {
                            when (row[0].substring(3)) {
                                "GLL" -> {
                                    ...
                                    var latDecimal =
                                        (latDegree.toFloat() + (latMinutes.toFloat() / 60)).toString()
                                    ...
                                    var longDecimal =
                                        (longDegree.toFloat() + (longMinutes.toFloat() / 60)).toString()
                                ...
                                "MWV" -> {
                                    var windAngle = row[1]
                                    var windSpeed = String.format("%.2f",windSpeedKnots(row[3].toFloat(), row[4]))
